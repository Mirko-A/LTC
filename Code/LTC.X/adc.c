...
uint16_t photores_front_raw  = 0u;
uint16_t photores_back_raw   = 0u;
uint16_t photores_left_raw   = 0u;
uint16_t photores_right_raw  = 0u;

uint16_t distance_back_raw   = 0u;
uint16_t distance_front_raw  = 0u;
...
void initADC(void)
{
    ...
    */
    ...
    /* PORTB pinovi TODO: postaviti pinove */
    ...
    /* Postavljamo pinove koji se koriste za A/D konverziju TODO: postaviti pinove */
...
{
    photores_front_raw = ADCBUF0;
	photores_back_raw = ADCBUF1;
    photores_left_raw = ADCBUF2;
	photores_right_raw = ADCBUF3;
	
    distance_front_raw = ADCBUF4;
	distance_back_raw = ADCBUF5;
